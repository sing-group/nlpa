 ...
 * represents a file name and then be processed by a {@link es.uvigo.esei.pipe.Pipe} into a CharSequence
 * representing the contents of the file, and eventually to a feature vector
 * holding indices into an {@link es.uvigo.esei.ia.types.Alphabet} holding words found in the file.
