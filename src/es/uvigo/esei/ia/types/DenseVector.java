...
public class DenseVector extends DenseMatrix implements Vector,
        Serializable {
    // Serialization
    ...
    public final int arrayCopyFrom(int i, Matrix m) {
        ...
        if (m instanceof DenseVector) {
            System.arraycopy(((DenseVector) m).values, 0, values, i,
                    ((DenseVector) m).values.length);
    ...
    public final int arrayCopyTo(int i, Matrix m) {
        ...
        if (m instanceof DenseVector) {
            System.arraycopy(values, i, ((DenseVector) m).values, 0,
                    ((DenseVector) m).values.length);
