...
public class BabelUtils {
	...
	public ArrayList<Pair<String, String>> buildSynsetVector(String fixedText, String lang) {
		...
		for (SemanticAnnotation annotation : bfyAnnotations) {
			...
			for (; !(start >= prevAnot.getStartIdx() && end <= prevAnot.getEndIdx()) && // The current anotation is
...
class BabelfyEntry {
	 ...
	 *
	 * @param endIdx
	 *            The last index of the entry
	 * @param synsetId
	 *            The synset ID
	 * @param score
	 *            The score
	 * @param startIdx
	 *            The start index of an entry
	 * @param text
