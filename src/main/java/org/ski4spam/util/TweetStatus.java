...
/**
  ...
  * @see twitter4j.TwitterResponse
  * Link to javadoc documentation of twitter4j: <a href="http://twitter4j.org/oldjavadocs/4.0.4-SNAPSHOT/index.html">http://twitter4j.org/oldjavadocs/4.0.4-SNAPSHOT/index.html</a>
...
public class TweetStatus implements Status {
    ...
    /**
		...
		* @return A list of country codes where the tweet is withheld - null if not withheld
		*/
    @Override
