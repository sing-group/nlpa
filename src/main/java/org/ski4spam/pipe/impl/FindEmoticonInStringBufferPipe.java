...
/**
 * This pipe finds and eventually drops emoticons
...
public class FindEmoticonInStringBufferPipe extends Pipe {
    ...
    */
    ...
    /**
		* Construct a StripEmoticonFromStringBufferPipe instance with the default configuration value
		*/
    ...
    /**
                Build a StripEmoticonFromStringBufferPipe that stores emoticons of the StringBuffer in the property emoticonProp
    ...
    * modifies it removing emoticons, and returns it.
    ...
    */
    ...
    public Instance pipe(Instance carrier) {
        if ( carrier.getData() instanceof StringBuffer){
                ...
                else logger.info("Emoticon not found for instance "+carrier.toString());
