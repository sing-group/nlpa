...
/**
 * This pipe finds and eventually drops emojis
...
public class FindEmojiInStringBufferPipe extends Pipe {
    ...
    */
    ...
    /**
		* Construct a StripEmojiFromStringBufferPipe instance with the default configuration value
		*/
    ...
    /**
                Build a StripEmojiFromStringBufferPipe that stores emojis of the StringBuffer in the property emojiProp
    ...
    * modifies it removing emojis, and returns it.
    ...
    */
    ...
    public Instance pipe(Instance carrier) {
        if ( carrier.getData() instanceof StringBuffer){
                ...
                String value = ""; 
 		          for (String i:EmojiParser.extractEmojis(data)) value+=(i);
                carrier.setProperty(emojiProp, value);
					 if (removeEmoji) carrier.setData(new StringBuffer(EmojiParser.removeAllEmojis(data)));
