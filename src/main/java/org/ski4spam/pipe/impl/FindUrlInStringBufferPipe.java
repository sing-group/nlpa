...
public class FindUrlInStringBufferPipe extends Pipe {
    ...
    */
    ...
    /**
    Build a FindUrlInStringBufferPipe that stores URLs of the StringBuffer in the property URLProp
    ...
    * modifies it removing URL, and returns it.
    ...
    */
    ...
    public Instance pipe(Instance carrier) {
         if ( carrier.getData() instanceof StringBuffer){
                ...
                else logger.info("URL not found for instance "+carrier.toString());
