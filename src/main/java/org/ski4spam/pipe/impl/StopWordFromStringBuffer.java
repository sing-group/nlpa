...
/**
 * This pipe drops stopwords from texts
 * The data of the instance should contain a StringBuffer without HTML Tags
...
public class StopWordFromStringBuffer extends Pipe {
	...
	/**
	  ...
	  * thanks to https://www.npmjs.com/package/stopwords-json
	  */
 			            ...
 			            "/stopwords-json/bg.json","/stopwords-json/bn.json",
 						   ...
 						   "/stopwords-json/cs.json","/stopwords-json/da.json",
 							...
 							"/stopwords-json/zh.json","/stopwords-json/zu.json"}){
								...
								try{	
	 				            InputStream is = StopWordFromStringBuffer.class.getResourceAsStream(i); 
