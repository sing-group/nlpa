...
public class FindUserNameInStringBufferPipe extends Pipe {
    ...
    */
    ...
    /**
    Build a StripUserNameFromStringBufferPipe that stores @userName of the StringBuffer in the property userNameProp
    ...
    * modifies it removing @userName, and returns it.
    ...
    */
    ...
    public Instance pipe(Instance carrier) {
         if ( carrier.getData() instanceof StringBuffer){
                ...
                else logger.info("@userName not found for instance "+carrier.toString());
