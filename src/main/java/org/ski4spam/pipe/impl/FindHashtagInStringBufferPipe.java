...
public class FindHashtagInStringBufferPipe extends Pipe {
  ...
  */
    ...
    */
    ...
    /**
		* Construct a StripHashtagFromStringBufferPipe instance with the default configuration value
		*/
    ...
    /**
                Build a StripHashtagFromStringBufferPipe that stores hashtags of the StringBuffer in the property hashtagProp
    ...
    * modifies it removing hashtags, and returns it.
