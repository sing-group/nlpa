...
public class SynsetFeatureVector implements Serializable {
    ...
    /**
     * Builds a SynsetFeatureVector from a Map (String,Double) where the string
     * represents the synsetID and the double contains the value for such
     * feature
     *
     * @param synsetFeature The synsetFeature Map used to build the
     * SynsetFeatureVector
     */
     ...
     * @return The value asociated to synsetId, which represents the frequency
     * of appearance of the synsetId
     */
