...
/**
 * This pipe detects the sentiment polarity of a synset sequence using lexicon
 * and adds the polarity as an instance property. The polarity score is within
 * the range [-1.0, 1.0].
 *
...
public class ComputeSynsetPolarityFromSynsetSequencePipe extends AbstractPipe {
    ...
    /**
     * Build a ComputePolarityFromLexicon instance that stores polarity of the
     * StringBuffer in the property polarityProp
     *
     * @param polarityProp The name of property to store polarity
     */
    public ComputeSynsetPolarityFromSynsetSequencePipe(String polarityProp) {
    ...
    /**
     * Compute the polarity of a synset sequence. For each synset gets its
     * polarity.
     *
