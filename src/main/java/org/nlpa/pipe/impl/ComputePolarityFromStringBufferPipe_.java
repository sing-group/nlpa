...
public class ComputePolarityFromStringBufferPipe_ extends AbstractPipe {

    /**
     * For logging purposes
     */
    private static final Logger logger = LogManager.getLogger(ComputePolarityFromStringBufferPipe_.class);
     ...
     */
    public ComputePolarityFromStringBufferPipe_() {
     ...
     */
    public ComputePolarityFromStringBufferPipe_(String polProp) {
