...
/**
 * This pipe saves the text in a property before doing any transformation to the text
 * 
...
public class SaveOriginalTextPropertyPipe extends AbstractPipe {
	 ...
	 *
	 * @param originalTextProperty The name of the property where the original text is stored
	 */
     ...
     *
     * @return String containing the property name for storing the original
     * text
     */
