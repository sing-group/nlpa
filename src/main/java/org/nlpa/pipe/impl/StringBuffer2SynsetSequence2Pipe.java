...
@TransformationPipe()
public class StringBuffer2SynsetSequence2Pipe extends AbstractPipe implements SharedDataProducer {
 ...
 synset id
     ...
     */
    public StringBuffer2SynsetSequence2Pipe() {
     ...
     */
    public StringBuffer2SynsetSequence2Pipe(Boolean replaceEmoticonProp, Boolean replaceEmojiProp) {
        super(new Class<?>[]{GuessLanguageFromStringBufferPipe.class}, new Class<?>[0]);
