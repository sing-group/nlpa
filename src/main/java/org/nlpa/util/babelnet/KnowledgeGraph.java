...
public class KnowledgeGraph
{
	 ...
	 * @param concept2paths The concept to pahts map
	 * @param paths2concept The paths to concepts map
	 * @param sourceWord2concepts The sourceword to concepts map
