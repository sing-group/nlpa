...
public enum KnowledgeGraphScorer
{
	 ...
	 * starting from it
	 * 
	 * @param disambiguationGraph The disambiguationGraph
	 * @param verticesToScore The VerticesToScore 
	 ...
	 * {@link KnowledgeGraph}.
	 * 
	 * @param disambiguationGraph The disambiguation Graph
	 * @return a {@link Map} from nodes to scores for all input vertices found
	 *         within the given graph
	 */
	public Map<String, Double> score(KnowledgeGraph disambiguationGraph)
	 ...
	 * 
	 * @param disambiguationGraph The disambiguation Graph
	 * @param verticesToScore The verticesTo score 
