...
public class KnowledgeGraphFactory
{
	 ...
	 * @return a KnowledgeGraph for the input words
	 * @throws IOException When a IO problem happens
	 */
	...
	/**
	 * Creates a KnowledgeGraph by exploring the graph of the knowledge
	 * base from the given source words and ending in any of the context words.
	 * 
	 * @param sourceWords The woruce words
	 * @param contextWords if <b>null</b> explores the graph at maximum depth with no
	 *            end-point (ie stopping at context words)
	 * @return a {@link KnowledgeGraph} for the input words
	 * @throws IOException When IO problem happens
	 */
	 ...
	 * 
	 * @param sourceWords the source words
	 * @param contextWords if <b>null</b> explores the graph at maximum depth with no
	 *            end-point
											...
											Collection<KnowledgeGraphPathFilter> filters) throws IOException
	{
		...
		Multimap<Word, String> sourceWordToConcept = /*new HashMultimap<Word, String>()*/HashMultimap.create();
	 ...
	 * @throws IOException in the case of an io exception
	 */
	 ...
	 * 
	 * @param sourceConcepts The source concepts
	 * @param contextConcepts The source concepts
	 ...
	 * 
	 * @param sourceConcepts The source concepts
	 * @param contextConcepts The context concepts
	 *            if <b>null</b> explores the graph at maximum depth with no
	 *            end-point
	 * @param filters the filters
	 * @return a {@link KnowledgeGraph} for the input words
	 ...
	 * 
	 * @param sourceConcepts The source concepts 
	 * @param sourceWord2concepts The wourceword to concepts map
											 ...
											 Collection<KnowledgeGraphPathFilter> filters) throws IOException
	{
		...
		Multimap<String, KnowledgeGraphPath> concept2paths = 
			/*new HashMultimap<String, KnowledgeGraphPath>()*/HashMultimap.create();
		...
		Multimap<Word, String> pathSourceWord2concepts = /*new HashMultimap<Word, String>()*/HashMultimap.create();
	...
	{	
		...
		Multimap<String, List<String>> firstConcept2pathsStartingWithSourceSense = 
			/*new HashMultimap<String, List<String>>()*/HashMultimap.create();
