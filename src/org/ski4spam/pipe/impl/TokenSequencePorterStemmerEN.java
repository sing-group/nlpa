...
import org.ski4spam.ia.util.Pair;
...
/**
 * Lematizaci�n por el algoritmo de Porter. Lematizaci�n en Ingl�s
 *
 * @author Jos� Ram�n M�ndez Reboredo
 * @since JDK 1.5
 */

public class TokenSequencePorterStemmerEN extends TokenSequencePorterStemmer implements Serializable {

    /**
     * Serial Version UID
     */
    private static final long serialVersionUID = -6938987663656573836L;

    public static void main(String args[]) {
        new TokenSequencePorterStemmerEN();
    }

    public TokenSequencePorterStemmerEN getPipe() {
        return this;
    }

    /**
     * Carga las reglas espec�ficas para el Stemmer en Ingl�s
     *
    ...
    protected void loadRules() {
        ...
        try {
            iStream = new FileReader(
                    new File(
                            getClass().getResource("porter_en.stm").toURI()
                    )
            );
        ...
        //Debug
        //System.out.println(super.extraerRaiz("worked"));
        //System.out.println(super.extraerRaiz("playing"));
        //System.out.println(super.extraerRaiz("beautiful"));
        //System.out.println(super.extraerRaiz("closed"));
    }
}
