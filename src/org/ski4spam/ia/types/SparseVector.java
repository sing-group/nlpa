 ...
 */
public class SparseVector implements ConstantMatrix, Vector {
    ...
    public SparseVector(int[] indices, double[] values, boolean copy,
        ...
        this(indices, values,
                ...
                (indices != null) ? indices.length : values.length, copy,
                checkIndicesSorted, removeDuplicates);
    }
    ...
    public int numLocations() {
        return (values == null
                ? (indices == null ? 0 : indices.length) : values.length);
    }
     ...
     */
    public final void map(Method f) throws Throwable {
    ...
    public double dotProduct(SparseVector v) {
        ...
        for (int i = 0; i < vShort.numLocations(); i++) {
            ret += vShort.valueAtLocation(i) * vLong.value(vShort.indexAtLocation(
                    i));
        }
    ...
    public void print() {
        ...
        if (values == null) {
            ...
            for (int i = 0; i < values.length; i++) {
                ...
                System.out.println("SparseVector[" + idx + "] = " +
                        values[i]);
            }
        }
    }
