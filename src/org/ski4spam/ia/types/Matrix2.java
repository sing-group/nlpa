...
public final class Matrix2 extends DenseMatrix {
    ...
    public boolean sizeMatches(ConstantMatrix m) {
        ...
        return (numDimensions == 2 && otherDims[0] == nr &&
                otherDims[1] == nc);
    }
     ...
     * false.
     */
    public final void setAll(double v, FeatureSelection fselection,
                             boolean ifSelected) {
     ...
     * "ifSelected" is false.
     */
    public final void rowSetAll(int ri, double v, FeatureSelection fselection,
                                boolean ifSelected) {
     ...
     * selection.
     */
    public final double rowDotProduct(int ri, Vector v, int maxCi,
